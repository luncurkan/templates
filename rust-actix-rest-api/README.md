...
A simple REST API starter template built with Rust and the Actix-web framework.
...
```bash
docker build -t rust-actix-rest-api .
docker run -p 3000:3000 -e DATABASE_URL=postgres://user:pass@host:5432/db rust-actix-rest-api
```
