...
A minimal WebSocket chat server built with Node.js and Hono.

## Stack

- **Runtime:** Node.js 22+
- **Framework:** Hono with @hono/node-ws
- **Language:** TypeScript
...
# Or build manually
docker build -t node-hono-websocket .
docker run -p 3000:3000 node-hono-websocket
```
